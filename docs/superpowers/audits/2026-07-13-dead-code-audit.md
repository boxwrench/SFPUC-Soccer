...
- res://assets/art/ui/mainmenu/title-sfpuc-hd-transparent.png — unreachable; zero basename hits (.import sidecar implied) — USER DECISION: archived to archive/raw-art/ instead of deleted (kept as editing source)
- res://assets/art/ui/mainmenu/title-sfpuc-hd.png — unreachable; zero basename hits (.import sidecar implied) — USER DECISION: archived to archive/raw-art/ instead of deleted (kept as editing source)
...
- res://assets/art/ui/teamselection/tournament-screen.png — unreachable; `scenes/screens/team_selection/team_selection_screen.tscn` uses `team-selection-background.png` instead (superseded asset); zero basename hits (.import sidecar implied) — USER DECISION: archived to archive/raw-art/ instead of deleted (kept as editing source)
